...
def _options_schema(
    scan_interval: int,
    enable_day_reading_date_sensor: bool,
    enable_meter_read_reading_date_sensor: bool,
) -> vol.Schema:
    ...
    return vol.Schema(
        {
            ...
            vol.Required(
                CONF_ENABLE_DAY_READING_DATE_SENSOR,
                default=enable_day_reading_date_sensor,
            ): cv.boolean,
            vol.Required(
                CONF_ENABLE_METER_READ_READING_DATE_SENSOR,
                default=enable_meter_read_reading_date_sensor,
            ): cv.boolean,
        }
    )
    ...
    return vol.Schema(
        {
            ...
            vol.Optional(
                CONF_ENABLE_DAY_READING_DATE_SENSOR,
                default=DEFAULT_ENABLE_DAY_READING_DATE_SENSOR,
            ): cv.boolean,
            vol.Optional(
                CONF_ENABLE_METER_READ_READING_DATE_SENSOR,
                default=DEFAULT_ENABLE_METER_READ_READING_DATE_SENSOR,
            ): cv.boolean,
        }
    )
...
class WienerNetzeSmartMeterCustomConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def _validate_auth(self, username: str, password: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            await self.hass.async_add_executor_job(smartmeter.session.close)
        ...
        if user_input is not None:
            try:
                ...
                data = {
                    ...
                    CONF_ENABLE_DAY_READING_DATE_SENSOR: user_input.get(
                        CONF_ENABLE_DAY_READING_DATE_SENSOR,
                        DEFAULT_ENABLE_DAY_READING_DATE_SENSOR,
                    ),
                    CONF_ENABLE_METER_READ_READING_DATE_SENSOR: user_input.get(
                        CONF_ENABLE_METER_READ_READING_DATE_SENSOR,
                        DEFAULT_ENABLE_METER_READ_READING_DATE_SENSOR,
                    ),
                }
...
class WienerNetzeSmartMeterOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input: dict[str, Any] | None = None):
        ...
        current_day_reading_date_sensor = self._config_entry.options.get(
            CONF_ENABLE_DAY_READING_DATE_SENSOR,
        ...
        current_meter_read_reading_date_sensor = self._config_entry.options.get(
            CONF_ENABLE_METER_READ_READING_DATE_SENSOR,
            self._config_entry.data.get(
                CONF_ENABLE_METER_READ_READING_DATE_SENSOR,
                DEFAULT_ENABLE_METER_READ_READING_DATE_SENSOR,
        ...
        return self.async_show_form(
            ...
            data_schema=_options_schema(
                ...
                current_day_reading_date_sensor,
                current_meter_read_reading_date_sensor,
            ),
        )
