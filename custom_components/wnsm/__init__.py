...
async def async_setup_entry(
    ...
    config.setdefault(CONF_ENABLE_DAY_READING_DATE_SENSOR, DEFAULT_ENABLE_DAY_READING_DATE_SENSOR)
    config.setdefault(CONF_ENABLE_METER_READ_READING_DATE_SENSOR, DEFAULT_ENABLE_METER_READ_READING_DATE_SENSOR)
